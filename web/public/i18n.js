...
(function () {
  ...
  const _en = {
    ...
    '\n检测到 start-services.sh 更新：请在宿主机执行 `docker restart openclaw-pro` 以使入口脚本变更生效。': '\nDetected start-services.sh update: run `docker restart openclaw-pro` on the host to apply entry script changes.',
    ...
    '执行: docker restart openclaw-pro': 'Run: docker restart openclaw-pro',
